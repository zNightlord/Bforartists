...
enum {
  ...
  V3D_OVERLAY_WPAINT_VGROUP_COLORS = (1 << 1),
};
...
enum eV3D_Overlay_WPaint_VGroupColorMode {
  ...
  V3D_OVERLAY_WPAINT_VGROUP_COLOR_VERTEX = 2,
  V3D_OVERLAY_WPAINT_VGROUP_COLOR_DEFORM = 3,
  V3D_OVERLAY_WPAINT_VGROUP_COLOR_ALL = 4,
};
