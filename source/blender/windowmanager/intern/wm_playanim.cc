...
int WM_main_playanim(int argc, const char **argv)
{
#ifdef WITH_AUDASPACE
  {
    ...
    if (!(g_audaspace.audio_device = bke::sound_device_init(nullptr, specs, 1024, "Bforartists"))) {
      g_audaspace.audio_device = bke::sound_device_init("None", specs, 0, "Bforartists");
    }
  }
#endif
