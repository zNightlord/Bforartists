...
static void rna_def_nodes(BlenderRNA *brna)
{
  ...
  define(brna, "GeometryNode", "GeometryNodeAttributeStatistic", nullptr, ICON_ATTRIBUTE_STATISTIC, "Add a Attribute Statistic Geometry node\nCalculate statistics about a data set from a field evaluated on a geometry");
  ...
  define(brna, "GeometryNode", "GeometryNodeExpression", def_geo_Expression); 
  ...
  define(brna, "GeometryNode", "GeometryNodeForeachGeometryElementInput", def_geo_foreach_geometry_element_input, ICON_NONE, "Add a For Each Element Input node\nFor Each Geometry Element Input used to start a series of operations for each element");
  define(brna, "GeometryNode", "GeometryNodeForeachGeometryElementOutput", def_geo_foreach_geometry_element_output, ICON_NONE, "Add a For Each Element Output node\nFor Each Geometry Element Output used to end a series of operations for each element");
