...
static void rna_def_nodes(BlenderRNA *brna)
{
  ...
  define(brna, "CompositorNode", "CompositorNodeSequencerStripInfo", nullptr, ICON_NONE);
  ...
  define(brna, "GeometryNode", "GeometryNodeFieldToGrid", def_geo_field_to_grid, ICON_NONE);
  ...
  define(brna, "GeometryNode", "GeometryNodeSDFGridFillet", nullptr, ICON_NONE);
  define(brna, "GeometryNode", "GeometryNodeSDFGridLaplacian", nullptr, ICON_NONE);
  define(brna, "GeometryNode", "GeometryNodeSDFGridMean", nullptr, ICON_NONE);
  define(brna, "GeometryNode", "GeometryNodeSDFGridMeanCurvature", nullptr, ICON_NONE);
  define(brna, "GeometryNode", "GeometryNodeSDFGridMedian", nullptr, ICON_NONE);
  define(brna, "GeometryNode", "GeometryNodeSDFGridOffset", nullptr, ICON_NONE);
