...
DEF_ICON_COLOR(CONVERT_TO_DISPLAY)
DEF_ICON_COLOR(CONVOLVE)
...
DEF_ICON_COLOR(COPY_FROM_OBJECT)
...
DEF_ICON_COLOR(IMAGE_COORDINATES)
...
DEF_ICON_COLOR(MASK_BY_COLOR)
DEF_ICON_COLOR(MASK_FACE_SETS)
DEF_ICON_COLOR(MASK_FACE_SETS_BOUNDARY)
DEF_ICON_COLOR(MASK_FACE_SETS_VISIBLE)
DEF_ICON_COLOR(MASK_MESH_BOUNDARY)
...
DEF_ICON_COLOR(NODE_ADVECTGRID)
...
DEF_ICON_COLOR(NODE_BUNDLE_COMBINE)
DEF_ICON_COLOR(NODE_BUNDLE_JOIN)
DEF_ICON_COLOR(NODE_BUNDLE_SEPARATE)
...
DEF_ICON_COLOR(NODE_CLOSURE)
DEF_ICON_COLOR(NODE_CLOSURE_EVALUATE)
...
DEF_ICON_COLOR(NODE_DISTRIBUTEPOINTSINGRID)
...
DEF_ICON_COLOR(NODE_ENABLE_OUTPUT)
DEF_ICON_COLOR(NODE_ENVIRONMENT)
DEF_ICON_COLOR(NODE_ERODE)
DEF_ICON_COLOR(NODE_FILEOUTPUT)
DEF_ICON_COLOR(NODE_FIELDTOGRID)
DEF_ICON_COLOR(NODE_FRAME)
DEF_ICON_COLOR(NODE_FRAMEJOIN)
DEF_ICON_COLOR(NODE_FRAMEPARENT)
DEF_ICON_COLOR(NODE_FRAMEREMOVE)
DEF_ICON_COLOR(NODE_FRESNEL)
DEF_ICON_COLOR(NODE_GAMMA)
DEF_ICON_COLOR(NODE_GET_NAMED_GRID)
...
DEF_ICON_COLOR(NODE_GRIDCURL)
DEF_ICON_COLOR(NODE_GRIDDIVERGENCE)
DEF_ICON_COLOR(NODE_GRIDGRADIENT)
DEF_ICON_COLOR(NODE_GRIDLAPLACIAN)
DEF_ICON_COLOR(NODE_GRIDTOMESH)
DEF_ICON_COLOR(NODE_GRID_INFO)
...
DEF_ICON_COLOR(NODE_JOINGROUP)
DEF_ICON_COLOR(NODE_JOINFRAMENAMED)
...
DEF_ICON_COLOR(NODE_MESHTODENSITYGRID)
DEF_ICON_COLOR(NODE_MESHTOSDFGRID)
...
DEF_ICON_COLOR(NODE_POINTSTOSDFGRID)
DEF_ICON_COLOR(NODE_PRINCIPLED)
DEF_ICON_COLOR(NODE_PRUNEGRID)
DEF_ICON_COLOR(NODE_RADIAL_ARRAY)
DEF_ICON_COLOR(NODE_RAY_PORTAL)
...
DEF_ICON_COLOR(NODE_SAMPLEGRID)
DEF_ICON_COLOR(NODE_SAMPLEGRIDINDEX)
DEF_ICON_COLOR(NODE_SDFGRIDBOOLEAN)
DEF_ICON_COLOR(NODE_SDFGRIDFILLET)
DEF_ICON_COLOR(NODE_SDFGRIDLAPLACIAN)
DEF_ICON_COLOR(NODE_SDFGRIDMEAN)
DEF_ICON_COLOR(NODE_SDFGRIDMEAN_CURVATURE)
DEF_ICON_COLOR(NODE_SDFGRIDMEDIAN)
DEF_ICON_COLOR(NODE_SDFGRIDOFFSET)
DEF_ICON_COLOR(NODE_SEL)
DEF_ICON_COLOR(NODE_SEPARATEHSV)
DEF_ICON_COLOR(NODE_SEPARATERGB)
DEF_ICON_COLOR(NODE_SEPARATEXYZ)
DEF_ICON_COLOR(NODE_SETGRIDBACKGROUND)
DEF_ICON_COLOR(NODE_SETGRIDTRANSFORM)
...
DEF_ICON_COLOR(NODE_STORENAMEDGRID)
...
DEF_ICON_COLOR(NODE_VOLUME_COEFFICIENTS)
DEF_ICON_COLOR(NODE_VOLUME_INFO)
DEF_ICON_COLOR(NODE_VOLUMEPRINCIPLED)
DEF_ICON_COLOR(NODE_VOLUMESCATTER)
DEF_ICON_COLOR(NODE_VOXELIZEGRID)
DEF_ICON_COLOR(NODE_VOXEL_INDEX)
...
DEF_ICON_COLOR(PANEL_TOGGLE_MAKE)
DEF_ICON_COLOR(PANEL_TOGGLE_UNLINK)
...
DEF_ICON_COLOR(PLAYHEAD_SNAP_OFF)
DEF_ICON_COLOR(PLAYHEAD_SNAP_ON)
...
DEF_ICON_COLOR(SEQ_STRIP_EXPAND)
DEF_ICON_COLOR(SEQ_STRIP_OVERWRITE)
DEF_ICON_COLOR(SEQ_STRIP_META)
DEF_ICON_COLOR(SEQ_STRIP_MODIFIER)
DEF_ICON_COLOR(SEQ_STRIP_SHUFFLE)
...
DEF_ICON_COLOR(SNAP_PLAYHEAD_OFF)
DEF_ICON_COLOR(SNAP_PLAYHEAD_ON)
...
DEF_ICON_COLOR(STRING_TO_VALUE)
...
DEF_ICON_COLOR(UI)
DEF_ICON_COLOR(UI_CHANNELS)
DEF_ICON_COLOR(UI_FOOTER_BAR)
DEF_ICON_COLOR(UI_HEADER_BAR)
DEF_ICON_COLOR(UI_SIDEBAR)
DEF_ICON_COLOR(UI_TOOLBAR)
...
DEF_ICON_COLOR(VISUAL_GEOMETRY_TO_OBJECTS)
...
DEF_ICON_VECTOR(NODE_STRUCTURE_AUTO)
DEF_ICON_VECTOR(NODE_STRUCTURE_DYNAMIC)
DEF_ICON_VECTOR(NODE_STRUCTURE_FIELD)
DEF_ICON_VECTOR(NODE_STRUCTURE_GRID)
DEF_ICON_VECTOR(NODE_STRUCTURE_SINGLE)
DEF_ICON_VECTOR(NODE_STRUCTURE_LIST)
