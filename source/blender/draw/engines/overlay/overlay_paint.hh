 ...
 public:
  void begin_sync(Resources &res, const State &state) final
  {
    ...
    if (state.ctx_mode == CTX_MODE_PAINT_WEIGHT) {
      ...
      const bool draw_vgroup_colors = state.overlay.wpaint_flag & V3D_OVERLAY_WPAINT_VGROUP_COLORS; /* new */
      ...
      auto weight_subpass = [&](const char *name, DRWState drw_state) {
        ...
        sub.push_constant("draw_vgroup_colors", draw_vgroup_colors);  /* new */
