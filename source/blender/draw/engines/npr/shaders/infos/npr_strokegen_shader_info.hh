...
*/
GPU_SHADER_CREATE_INFO(npr_segloopconv1D_build_patch)
  .typedef_source("bnpr_shader_shared.hh")
  .define("LOOPCONV1D_DATA_TYPE", "uint")
  .define("LOOPCONV1D_TAG", "_buld_patch")
...
GPU_SHADER_CREATE_INFO(strokegen_segloopconv1D_test_build_patch)
  ...
  /*.define("_KERNEL_MULTI_COMPILE__TREE_SCAN_UPSWEEP", "1")*/
  .storage_buf(0, Qualifier::READ_WRITE, NPR_SEGLOOPCONV1D_TEST_DATA_TYPE_STR, "ssbo_in_segloopconv1d_data_[]")
  .storage_buf(1, Qualifier::READ_WRITE, NPR_SEGLOOPCONV1D_TEST_DATA_TYPE_STR, "ssbo_out_segloopconv1d_data_[]")
  .uniform_buf(0, "UBO_SegLoopConv1D", "ubo_segloopconv1d_")
