...
#endif
//
// VertexGroupWeightInput::VertexGroupWeightInput(const float4x4 &target_to_armature,
//                                               const int def_nr)
...
//}
//
// VertexGroupSelectionInput::VertexGroupSelectionInput(const float4x4 &target_to_armature,
//                                                     const int def_nr,
...
//}
//
// GVArray VertexGroupSelectionInput::get_varray_for_context(const bke::GeometryFieldContext
// &context,
//                                                          const IndexMask &mask) const
//{
//  fn::FieldEvaluator evaluator{context, mask.min_array_size()};
...
//}
//
// GVArray BoneEnvelopeWeightInput::get_varray_for_context(const bke::GeometryFieldContext
// &context,
//                                                        const IndexMask &mask) const
//{
//  fn::FieldEvaluator evaluator{context, mask.min_array_size()};
