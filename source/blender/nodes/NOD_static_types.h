...
DefNode(GeometryNode, GEO_NODE_SET_MATERIAL, 0, "SET_MATERIAL", SetMeshNormal, "Set Mesh Normal", "Set the normal of each selected mesh element")
DefNode(GeometryNode, GEO_NODE_SET_MESH_NORMAL, 0, "SET_MESH_NORMAL", SetMaterial, "Set Material", "Assign a material to geometry elements")
