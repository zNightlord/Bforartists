...
{
  NodeShaderForeachLightInput *data = MEM_callocN<NodeShaderForeachLightInput>(__func__);
...
static void node_init(bNodeTree * /*tree*/, bNode *node)
{
  NodeShaderForeachLightOutput *data = MEM_callocN<NodeShaderForeachLightOutput>(__func__);

  data->next_identifier = 0;

  data->items = MEM_malloc_arrayN<NodeShaderForeachLightItem>(1, __func__);
...
static void node_copy_storage(bNodeTree * /*dst_tree*/, bNode *dst_node, const bNode *src_node)
{
  ...
  auto *dst_storage = MEM_dupallocN<NodeShaderForeachLightOutput>(__func__, src_storage);
