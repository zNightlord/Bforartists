                                ...
                                float4 &r_delta_rotation)
{
  ...
  // // const float4 lambda_damping = quaternion_difference(math::conjugate(rotation),
  // //                                                     math::Quaternion::identity()) +
  // //                               quaternion_difference(rotation_diff,
  // //                               math::Quaternion::identity());
  // UNUSED_VARS(lambda, alpha, gamma, old_rotation);
