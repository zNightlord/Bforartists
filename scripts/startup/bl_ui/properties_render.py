...
class RENDER_PT_npr_test(RenderButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        col.prop(props, "npr_test_val_3",  text="geodist_deviation")
        col.prop(props, "npr_test_val_4",  text="alternate quadric filter type 0")
        col.prop(props, "npr_test_val_5",  text="alternate quadric filter type 1")
        col.prop(props, "npr_test_val_6",  text="visualize filtered geom")
        col.prop(props, "npr_test_val_7",  text="draw hidden geom")
