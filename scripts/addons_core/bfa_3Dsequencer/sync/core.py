...
def sync_system_update(context: bpy.types.Context, force: bool = False):
    ...
    builtin_bidirection = context.screen.is_animation_playing and not sync_settings.is_legacy()
    if sync_settings.bidirectional and not master_time_changed and not builtin_bidirection:
